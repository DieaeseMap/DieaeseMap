async function setNaverNewsData() {
  ...
  try {
    const response = await fetch("https://port-0-diseasemap-1pgyr2mlvlp2ppo.sel5.cloudtype.app/api/news");
...
async function setDaumNewsData() {
  ...
  try {
      const response = await fetch("https://port-0-diseasemap-1pgyr2mlvlp2ppo.sel5.cloudtype.app/api/news2");
